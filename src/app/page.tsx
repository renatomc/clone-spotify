   ...
   <div className="h-screen flex flex-col">
     <div className="flex flex-1">
       <aside className="w-72 bg-zinc-950 p-6">
         ...
         <nav className='mt-6 pt-6 border-t border-zinc-800 flex flex-col gap-3'>
          ...
          <a href="" className='text-sm text-zinc-400 hover:text-zinc-100'>My Playlist
          </a>
       ...
       <main className="flex-1 p-6">
         ...
         <div className='grid grid-cols-3 gap-4 mt-4'>
           <a href='' className='bg-white/5 group rounded flex items-center gap-4 overflow-hidden hover:bg-white/10 transition-colors'>
             <Image src="/images/image.jpeg" width={104} height={104} alt="Capa do álbum" />
     ...
     <footer className="bg-zinc-800 border-t border-zinc-700 p-6 flex items-center justify-between">
       <div className='flex items-center gap-3'>
        <Image className='w-fit' src="/images/image.jpeg" width={56} height={56} alt="Capa do álbum" />
        <div className='flex flex-col'>
          <strong className='font-normal'>Rope</strong>
          <span className='text-xs text-zinc-400'>Foo Fighteres</span>
        </div>
       </div>
